...
# the bemicro_cv_ddr3_control_p0_pin_map.tcl script.
# All the memory interface parameters are defined in the
# bemicro_cv_ddr3_control_p0_parameters.tcl script
...
global ::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard
global ::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard_differential
global ::GLOBAL_bemicro_cv_ddr3_control_p0_dqs_group_size
global ::GLOBAL_bemicro_cv_ddr3_control_p0_number_of_dqs_groups
global ::GLOBAL_bemicro_cv_ddr3_control_p0_uniphy_temp_ver_code
...
source "$script_dir/bemicro_cv_ddr3_control_p0_parameters.tcl"
...
foreach asgn_type $asgn_types {
	remove_all_instance_assignments -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename -name $asgn_type
}
...
bemicro_cv_ddr3_control_p0_initialize_ddr_db ddr_db
...
foreach inst $instances {
   ...
   if {$is_av_soc_device} {
	...
	foreach rzq_pin $all_rzq_pins {
				set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $rzq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}
	
  # 1.35V DDR3L pin assignments
  if { ! [ string compare $::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard "SSTL-135" ] } {
    foreach dq_pin $pins(all_dq_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name INPUT_TERMINATION "PARALLEL 40 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
    ...
    foreach ac_pin $pins(ac_wo_reset_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $ac_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITHOUT CALIBRATION" -to $ac_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
    
    foreach reset_pin $pins(reset_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $reset_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name BOARD_MODEL_FAR_PULLUP_R OPEN -to $reset_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    ...
    foreach dm_pin $pins(dm_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $dm_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name OUTPUT_TERMINATION "SERIES 40 OHM WITH CALIBRATION" -to $dm_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
  } else {
    # 1.5V DDR3 pin assignments

    foreach dq_pin $pins(all_dq_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard CLASS I" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name INPUT_TERMINATION "PARALLEL 50 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION" -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
    ...
    foreach ac_pin $pins(ac_wo_reset_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard CLASS I" -to $ac_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to $ac_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
    
    foreach reset_pin $pins(reset_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard_cmos" -to $reset_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name CURRENT_STRENGTH_NEW "MAXIMUM CURRENT" -to $reset_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
    

    foreach dm_pin $pins(dm_pins) {
      set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard CLASS I" -to $dm_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
      set_instance_assignment -name OUTPUT_TERMINATION "SERIES 50 OHM WITH CALIBRATION" -to $dm_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    }
  }

	foreach refclk_pin $pins(pll_ref_clock) {
		if {![string compare [get_instance_assignment -to $refclk_pin -name IO_STANDARD] ""]} {
			set_instance_assignment -name IO_STANDARD "$::GLOBAL_bemicro_cv_ddr3_control_p0_io_standard" -to $refclk_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
    		}
	}

	set ::GLOBAL_bemicro_cv_ddr3_control_p0_dqs_group_size_constraint $::GLOBAL_bemicro_cv_ddr3_control_p0_dqs_group_size
	if { $::GLOBAL_bemicro_cv_ddr3_control_p0_dqs_group_size == 8 } {
		set ::GLOBAL_bemicro_cv_ddr3_control_p0_dqs_group_size_constraint 9
	}
	...
	foreach dq_pin $pins(all_dq_pins) {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $dq_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}
	foreach dm_pin $pins(dm_pins) {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $dm_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}
	foreach dqs_pin [ concat $pins(dqs_pins) $pins(dqsn_pins) ] {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $dqs_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}

	# Disable package skew compensation for address/command pins in timing analysis
	foreach ac_pin $pins(ac_pins) {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $ac_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}
	foreach ck_pin [ concat $pins(ck_pins) $pins(ckn_pins) ] {
		set_instance_assignment -name PACKAGE_SKEW_COMPENSATION OFF -to $ck_pin -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}
	...
	# Avalon Clock
	set pll_avl_clock [ bemicro_cv_ddr3_control_p0_get_pll_clock_name_for_acf $pins(pll_avl_clock) "pll_avl_clk" ]

	# Scan Chain Configuration CLock
	set pll_config_clock [ bemicro_cv_ddr3_control_p0_get_pll_clock_name_for_acf $pins(pll_config_clock) "pll_config_clk" ]


	if { $::GLOBAL_bemicro_cv_ddr3_control_p0_num_pll_clock == [ expr 5 + $seq_clks + $dr_clk + $qr_related_clks ] } {
		set_instance_assignment -name GLOBAL_SIGNAL "DUAL-REGIONAL CLOCK" -to $pll_avl_clock -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename

		set_instance_assignment -name GLOBAL_SIGNAL "DUAL-REGIONAL CLOCK" -to $pll_config_clock -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	} else {
		post_message -type critical_warning "Expected [ expr 5 + $seq_clks + $dr_clk + $qr_related_clks ] PLL clocks but found $::GLOBAL_bemicro_cv_ddr3_control_p0_num_pll_clock!"
	}

	set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|p0|umemphy|ureset|phy_reset_mem_stable_n" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|p0|umemphy|ureset|phy_reset_n" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|s0|sequencer_rw_mgr_inst|rw_mgr_inst|rw_mgr_core_inst|rw_soft_reset_n" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	
	for {set i 0} {$i < $::GLOBAL_bemicro_cv_ddr3_control_p0_number_of_dqs_groups} {incr i 1} {
		set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|p0|umemphy|uio_pads|dq_ddio[$i].read_capture_clk_buffer" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
		set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|p0|umemphy|uread_datapath|reset_n_fifo_write_side[$i]" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
		set_instance_assignment -name GLOBAL_SIGNAL OFF -to "${inst}|p0|umemphy|uread_datapath|reset_n_fifo_wraddress[$i]" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	}

	set_instance_assignment -name ENABLE_BENEFICIAL_SKEW_OPTIMIZATION_FOR_NON_GLOBAL_CLOCKS ON -to $inst -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
	
	# Use direct compensation mode to minimize jitter
	set_instance_assignment -name PLL_COMPENSATION_MODE DIRECT -to "${inst}|pll0|fbout" -tag __$::GLOBAL_bemicro_cv_ddr3_control_p0_corename
}

bemicro_cv_ddr3_control_p0_dump_all_pins ddr_db

if { [ llength $quartus(args) ] > 1 } {
	set param [lindex $quartus(args) 1]

	if { [ string match -dump_static_pin_map $param ] } {
		set filename "${::GLOBAL_bemicro_cv_ddr3_control_p0_corename}_static_pin_map.tcl"

		bemicro_cv_ddr3_control_p0_dump_static_pin_map ddr_db $filename
	}
}
