// bemicro_cv_ddr3_control_s0_mm_interconnect_0.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2014.10.29.21:49:36

`timescale 1 ps / 1 ps
module bemicro_cv_ddr3_control_s0_mm_interconnect_0 (
	...
	wire  [93:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> cpu_inst_instruction_master_agent:rp_data
	wire   [3:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> cpu_inst_instruction_master_agent:rp_channel
	...
	wire         hphy_bridge_s0_agent_rdata_fifo_src_valid;                                      // hphy_bridge_s0_agent:rdata_fifo_src_valid -> hphy_bridge_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] hphy_bridge_s0_agent_rdata_fifo_src_data;                                       // hphy_bridge_s0_agent:rdata_fifo_src_data -> hphy_bridge_s0_agent:rdata_fifo_sink_data
	wire         hphy_bridge_s0_agent_rdata_fifo_src_ready;                                      // hphy_bridge_s0_agent:rdata_fifo_sink_ready -> hphy_bridge_s0_agent:rdata_fifo_src_ready
	...
	wire  [93:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> hphy_bridge_s0_agent:cp_data
	...
	wire  [94:0] sequencer_scc_mgr_inst_avl_agent_rf_source_data;                                // sequencer_scc_mgr_inst_avl_agent:rf_source_data -> sequencer_scc_mgr_inst_avl_agent_rsp_fifo:in_data
	...
	wire  [94:0] sequencer_scc_mgr_inst_avl_agent_rsp_fifo_out_data;                             // sequencer_scc_mgr_inst_avl_agent_rsp_fifo:out_data -> sequencer_scc_mgr_inst_avl_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> sequencer_scc_mgr_inst_avl_agent:cp_data
	...
	wire  [94:0] sequencer_reg_file_inst_avl_agent_rf_source_data;                               // sequencer_reg_file_inst_avl_agent:rf_source_data -> sequencer_reg_file_inst_avl_agent_rsp_fifo:in_data
	...
	wire  [94:0] sequencer_reg_file_inst_avl_agent_rsp_fifo_out_data;                            // sequencer_reg_file_inst_avl_agent_rsp_fifo:out_data -> sequencer_reg_file_inst_avl_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> sequencer_reg_file_inst_avl_agent:cp_data
	...
	wire  [93:0] cpu_inst_instruction_master_agent_cp_data;                                      // cpu_inst_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         hphy_bridge_s0_agent_rp_endofpacket;                                            // hphy_bridge_s0_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire         hphy_bridge_s0_agent_rp_valid;                                                  // hphy_bridge_s0_agent:rp_valid -> router_002:sink_valid
	wire         hphy_bridge_s0_agent_rp_startofpacket;                                          // hphy_bridge_s0_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire  [93:0] hphy_bridge_s0_agent_rp_data;                                                   // hphy_bridge_s0_agent:rp_data -> router_002:sink_data
	wire         hphy_bridge_s0_agent_rp_ready;                                                  // router_002:sink_ready -> hphy_bridge_s0_agent:rp_ready
	...
	wire         sequencer_mem_s1_agent_rp_endofpacket;                                          // sequencer_mem_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire         sequencer_mem_s1_agent_rp_valid;                                                // sequencer_mem_s1_agent:rp_valid -> router_003:sink_valid
	wire         sequencer_mem_s1_agent_rp_startofpacket;                                        // sequencer_mem_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire  [93:0] sequencer_mem_s1_agent_rp_data;                                                 // sequencer_mem_s1_agent:rp_data -> router_003:sink_data
	wire         sequencer_mem_s1_agent_rp_ready;                                                // router_003:sink_ready -> sequencer_mem_s1_agent:rp_ready
	...
	wire  [93:0] sequencer_scc_mgr_inst_avl_agent_rp_data;                                       // sequencer_scc_mgr_inst_avl_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] sequencer_reg_file_inst_avl_agent_rp_data;                                      // sequencer_reg_file_inst_avl_agent:rp_data -> router_005:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (hphy_bridge_s0_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (hphy_bridge_s0_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (hphy_bridge_s0_agent_rdata_fifo_src_data),        //                .data
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router router (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router_001 router_001 (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router_002 router_002 (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router_003 router_003 (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router_002 router_004 (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_router_002 router_005 (
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	bemicro_cv_ddr3_control_s0_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
